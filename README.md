...
This repository contains the interactive HTML prototype developed for 
**Assignment 5 – Develop Prototype** for ATU Galway.
...
## Project Summary
Smart Campus Assistant is a multi-page prototype designed to help students quickly 
access essential university information such as:
- Login screen (demo mode)
- Timetable (with day filter)
...
The prototype is built using **HTML, CSS, and JavaScript** and does not include 
real authentication or backend logic. All interactions are client-side only.

## How to run the prototype
1. Download the repository / clone it  
2. Open **index.html** in any browser  
3. Use the top navigation bar to move between screens  

The prototype simulates:
- login behaviour  
- timetable filtering  
- opening news and events  
- navigating between sections  

## Sprint Coverage (based on Release Plan)
**Sprint 1:** Login, Authentication flow mock, Timetable (week view), Filtering  
**Sprint 2:** News, Events, Categories, News/Event details  
**Sprint 3:** Contacts, UI polish, Performance improvements  
...
This repository is used as evidence of:
- Prototype development  
- Individual + team contributions  
- Sprint progress  
- Ongoing updates as required by the lecturer
